...
실습 중 자주 막히는 상황에서 ChatGPT에게 다시 부탁하는 흐름을 정리합니다. 본문에는 프롬프트(prompt) 앞 3줄만 보이고, 복사하기 버튼으로 전문을 보낼 수 있습니다.
...
> 프롬프트(prompt) 박스: repair-wrong-answer
> 표시: 앞 3줄 미리보기
> 버튼: 복사하기
...
> 프롬프트(prompt) 박스: repair-pages-url
> 표시: 앞 3줄 미리보기
> 버튼: 복사하기

독자 행동 안내: ChatGPT에게 현재 보이는 화면과 마지막 답변을 함께 설명해 주세요.

주소가 열렸다면 데스크톱(desktop), 휴대전화, 시크릿 창에서 한 번씩 확인합니다. 사용자가 리모트 환경에서 직접 확인하기 어렵다면 작업자가 배포 URL(Uniform Resource Locator)을 열어 보고 화면 상태를 함께 보고해야 합니다.
...
> 프롬프트(prompt) 박스: repair-image-broken
> 표시: 앞 3줄 미리보기
> 버튼: 복사하기

독자 행동 안내: 깨진 화면이 보이면 캡처(capture)하거나 상황을 적어 ChatGPT에게 전달해 주세요.

### 5페이지. 다음에 만들어 볼 수 있는 사이트

![이미지 자리: 다음 사이트 아이디어 카드 모음](../webbook/images/ch09_05_next_ideas.png)

첫 사이트와 타로(tarot) 사이트를 완성했다면, 이제 다른 주제로 바꿔 볼 수 있습니다.  
가게 소개, 포트폴리오, 행사 안내, 제품 소개처럼 이미지를 중심으로 만든 사이트가 다음 실습에 좋습니다.

> 프롬프트(prompt) 박스: next-site-ideas
> 표시: 앞 3줄 미리보기
> 버튼: 복사하기
