...
실습 중 자주 막히는 상황에서 ChatGPT에게 다시 부탁하는 흐름을 정리합니다. 실제 프롬프트 전문은 Phase 3에서 별도 파일로 정리하고, 이 장에서는 상황별 자리와 사용 흐름을 잡습니다.
...
![이미지 자리: 엉뚱한 답변을 바로잡는 프롬프트 박스](../webbook/images/ch09_02_wrong_answer_prompt.png)
