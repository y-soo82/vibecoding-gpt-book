...
### 4페이지. 첫 번째 사이트 제작 프롬프트 복사하기

![이미지 자리: 첫 사이트 제작 프롬프트 박스](../webbook/images/ch02_04_first_site_prompt.png)
...
독자 행동 안내: 답변이 끝날 때까지 같은 프롬프트를 다시 보내지 마세요.
...
바이브코딩은 한 번에 맞히는 작업이 아니라, 보면서 조금씩 맞춰 가는 작업입니다.
...
독자 행동 안내: 모바일 화면에서 제목과 버튼이 잘리지 않는지 확인해 주세요.
