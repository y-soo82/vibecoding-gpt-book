...
아래 화면은 이미지 한 장에서 시작해 만든 첫 웹사이트 결과입니다.

![이미지 자리: 이미지 한 장으로 만든 첫 웹사이트 완성 예시](../webbook/images/ch02_01_first_site_preview.png)

결과는 큰 제목, 짧은 설명, 이미지, 버튼이 있는 한 페이지 사이트입니다. 목표는 복잡한 기능이 아니라 “내가 부탁해서 화면이 만들어졌다”는 첫 경험입니다.
...
![이미지 자리: 첫 사이트 제작 프롬프트 입력 화면](../webbook/images/ch02_04_first_site_prompt.png)
...
![이미지 자리: 첫 사이트 수정 요청 프롬프트 박스](../webbook/images/ch02_08_revise_prompt.png)
...
![이미지 자리: 첫 사이트 모바일 결과 화면](../webbook/images/ch02_10_first_site_mobile.png)
...
![이미지 자리: 첫 사이트 배포 요청 프롬프트 박스](../webbook/images/ch03_10_deploy_prompt.png)
...
![이미지 자리: 첫 사이트 모바일 외부 URL 결과 화면](../webbook/images/ch03_14_first_site_public_mobile.png)
